    ...
    <div class="tmds-card">
      ...
      <div class="tmds-row" style="margin-top:10px">
        <div class="tmds-field">
          ...
          <small>Set this on each device. A change may wait for an upload check and then a
          download check, plus transfer time. Deletions retain a separate 90-second safety delay.</small>
        </div>
      </div>
      <div class="tmds-field">
  ...
  <div class="tmds-foot">
    ...
    refreshPanel() {
      ...
      set("tmds-interval-status", readCfg(K.enabled, "true") === "true"
        ? `Saved interval: ${Scheduler.intervalMs() / 1000} seconds. Checks run automatically once configured.`
