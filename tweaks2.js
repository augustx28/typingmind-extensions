(function () {
  ...
  function ensureMobileTweaksPositionStyle() {
    const styleId = "tweak-mobile-position-style";
    ...
    styleElement.textContent = `
      @media (max-width: 431px) {
        .gap-1:has(> [data-element-id="workspace-tab-drivesync"]) > #workspace-tab-tweaks {
  ...
  function initializeTweaks() {
    ...
    ensureMobileTweaksPositionStyle();
