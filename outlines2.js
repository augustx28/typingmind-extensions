this is the JS I'm using on typingmind to show me the outlines and headers when I open it it seems to be a little small mostly when I'm using it on my phone can you increase the font size by a little bit and also I'd like to have a feature where the header one or larger header fonts are more thicker and heavier compared to the different headers. design is really important improve anything else that would help in order to make it more optimal and make it more real good quality design but keep everything else the same.
