// TypingMind Page Outline Extension v4.3.1
// Groups response headings beneath each user input.
// Toggle button (draggable) or Ctrl/Cmd + Shift + O.
//
// v4.3.1 changes (styling only, no logic touched):
// - All panel text is 1px larger so it reads easier, mostly on phones.
// - Level-1 headings (the top heading in each reply) are now bold (700)
//   so they stand out from the sub-headings.
// - Levels 2 to 4 step down through warm grays, one shade lighter per
//   level, with matching shades for dark mode.
//
// v4.3 changes:
