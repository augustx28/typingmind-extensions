/* ==========================================================================
 * TypingMind Chat Export (.md)  v1.3.3
 * --------------------------------------------------------------------------
 ...
 *   as the model wrote them. Each question has an H5 "You" heading and a
...
(function () {
  ...
  // Your question stays in a box, collapsed under "You" by default.
  ...
  function renderItems(items, ctx, forcedLabel) {
    ...
    items.forEach((m) => {
      ...
      // "You" heading and quote box as top-level questions.
      if (m.role === 'user') {
