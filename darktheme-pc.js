(() => {
  ...
  const css = `
    ...
    /* ─────────────────────────────────────────────
       10) DARK MODE: subtle AI response borders
       Desktop / larger screens only
       Works dynamically across response IDs/models
       ───────────────────────────────────────────── */
    @media (min-width: 768px) {
      ...
      /* Catch response/card border variations used by different layouts/models */
