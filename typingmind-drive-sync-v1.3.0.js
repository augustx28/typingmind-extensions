    ...
    async connectOffline() {
      ...
      const code = await new Promise((resolve, reject) => {
        ...
        const poll = setInterval(() => {
          if (popup.closed) return finish(reject, new Error("The sign-in window was closed."));
          let href = "";
          try {
    ...
    <div class="tmds-card">
      ...
      <div class="tmds-guide tmds-hidden" id="tmds-guide">
        <ol>
          ...
          <li>Add this exact address to <strong>Authorized redirect URIs</strong>: <code>${escapeAttr(location.origin + location.pathname)}</code></li>
