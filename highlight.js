(() => {
  ...
  function applySegmentShape(
    ...
    mark.dataset.tmphSegmentIndex =
      String(segmentIndex);

    mark.dataset.tmphSegmentCount =
      String(segmentCount);

    if (segmentCount <= 1) {
      mark.style.borderRadius = radius;
  ...
  function initialize() {
    ...
    console.info(
      `[TypingMind Highlighter] Version ${VERSION} loaded. Continuous rounded highlight mode enabled.`
    );
  }
