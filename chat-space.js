...
(() => {
  ...
  const T = {
    ...
    tabW: 30,
    tabH: 22,
    tabRise: 16,          // how far the chip's top sits above the message box
  };
...
`;
  ...
  function syncParts() {
    ...
    // mode the minimized state is deliberately kept across chats.
  ...
  function updateTabLabel() {
    ...
    const label = !on ? 'Space Saver options' : hidden ? 'Restore the header' : 'Minimize the header';
