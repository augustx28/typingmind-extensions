...
//
// v4.4 changes:
// - Redesigned the floating outline button with a glassmorphism style.
// - Increased the button from 30px to 32px.
// - Replaced the simple three-line icon with an outline hierarchy/tree icon.
// - Added improved light/dark hover, active, and dragging states.
//
// v4.3 changes:
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      #${TOGGLE_ID}.active {
        background: linear-gradient(
          135deg,
          rgba(215, 170, 75, 0.32),
          rgba(200, 155, 60, 0.18)
        );
        color: rgba(175, 128, 42, 1);
        border-color: rgba(200, 155, 60, 0.4);
        box-shadow:
          0 2px 12px rgba(200, 155, 60, 0.18),
      ...
      .dark #${TOGGLE_ID}.active {
        background: linear-gradient(
          135deg,
          rgba(220, 175, 85, 0.3),
          rgba(210, 165, 70, 0.16)
        );
        color: rgba(228, 186, 95, 1);
        border-color: rgba(215, 170, 75, 0.35);
        box-shadow:
          0 2px 12px rgba(210, 165, 70, 0.15),
  ...
  function createToggleButton() {
    ...
    button.innerHTML = `
      ...
      >
        ...
        <path d="M4 5.5v5A1.5 1.5 0 0 0 5.5 12H7"></path>
        <path d="M4 5.5v12A1.5 1.5 0 0 0 5.5 19H7"></path>
        <circle
          cx="4"
          cy="5.5"
          r="1.1"
